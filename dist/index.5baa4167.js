...
document.querySelector("#loginForm").addEventListener("submit", (e)=>{
    ...
    if (loginEmail.value.trim() !== "" && loginPassword.value.trim() !== "") {
        ...
        _axiosDefault.default.post("https://todoo.5xcamp.us/users/sign_in", loginUserData).then((resp)=>{
...
document.querySelector("#checkform").addEventListener("submit", (e)=>{
    ...
    if (token2) {
        console.log(token2);
        _axiosDefault.default.get("https://todoo.5xcamp.us/check", {
            headers: {
...
if (token) _axiosDefault.default.get("https://todoo.5xcamp.us/todos", {
    headers: {
        Authorization: token
    }
}).then(({ data  })=>{
...
},{}]},["d5kvp","igcvL"], "igcvL", "parcelRequiree0b9")
